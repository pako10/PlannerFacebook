...
public class RegistroActivity extends LoginActivity implements AdapterView.OnItemSelectedListener{
    Button   BtRegistrate;
    EditText etName;
    EditText etLastName;
    EditText etEmail;
    ...
    public  void executeC(){
        Intent i = new Intent(RegistroActivity.this,MenuMain2Activity.class);
        startActivity(i);
    }
